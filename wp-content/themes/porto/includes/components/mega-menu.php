	        ...
	        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
                ...
                <p class="field-custom description-wide">
    				<label for="edit-menu-item-isMega-<?php echo $item_id; ?>">
    					<input type="checkbox" id="edit-menu-item-isMega-<?php echo $item_id; ?>" value="1" name="menu-item-isMega[<?php echo $item_id; ?>]"<?php checked( $item->isMega, '1' ); ?> />
    					<?php _e( 'Make this Mega Menu' ); ?>
    				</label>
    			</p>
	            <?php
...
class SpyropressMegaMenu {
    ...
    function update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
        ...
        if ( isset( $_REQUEST['menu-item-isMega'] ) && is_array( $_REQUEST['menu-item-isMega'] ) ) {
            $isMega = isset( $_REQUEST['menu-item-isMega'][$menu_item_db_id] ) ? 1 : 0;
            update_post_meta( $menu_item_db_id, '_menu_item_isMega', $isMega );
        }
        else {
            delete_post_meta( $menu_item_db_id, '_menu_item_isMega' );
        }
    }
