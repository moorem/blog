...
echo '<ul class="list icons list-unstyled">';
    if ( $address )
        echo '<li><i class="icon icon-map-marker"></i> <strong>'. $address_title .'</strong> ' . $address . '</li>';
    
    if ( $email )
        echo '<li><i class="icon icon-envelope"></i> <strong>'. $email_title .'</strong> <a href="mailto:' . $email . '">' . $email . '</a></li>';
