...
function spyropress_sc_blockquote( $atts = array(), $content = '' ) {
    ...
    if( 's1' == $style ) {
        ...
        $content = str_replace( '<p>', '<p><i class="icon icon-quote-left"></i> ', $content, $count );
    }
    else {
...
function spyropress_sc_icon_list( $atts = array(), $content = '' ) {
    ...
    return str_replace( '<li>', '<li><i class="icon ' . $icon . '"></i> ', $content );
}
...
function spyropress_sc_rotate_words( $atts = array(), $content = '' ) {
    ...
    return '<span class="word-rotate"><span class="word-rotate-items"><span>' . $content . '</span></span></span>';
}
