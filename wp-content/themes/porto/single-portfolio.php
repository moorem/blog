                ...
                <div class="portfolio-title">
                    ...
                    <?php } else { ?>
						<div class="portfolio-nav-all col-md-1">
							<a href="<?php echo home_url( '/portfolio/' ) ?>" rel="tooltip" data-original-title="<?php esc_attr_e( 'Back to list', 'spyropress' ) ?>"><i class="icon icon-th"></i></a>
						</div>
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        elseif( 'video' == $showcase_type ) {
                            echo wp_oembed_get( get_post_meta( get_the_ID(), 'video', true ) );
                        }
                	...
                	<div class="<?php echo $col2; ?>">
                        ...
                        <div class="portfolio-info">
							<div class="row">
								<div class="col-md-12 center">
									<ul>
										<li>
                                            <a href="#" rel="tooltip" data-original-title="<?php esc_attr_e( 'View', 'spyropress' ) ?>"><i class="icon icon-eye"></i><?php spyropress_post_views( get_the_ID(), '', '' ) ?></a>
										</li>
										<li>
                        ...
                        if( $live_url )
                            echo '<a href="' . $live_url . '" class="btn btn-primary btn-icon"><i class="icon icon-external-link"></i>' . $translate['preview-title'] . '</a> <span class="arrow hlb hidden-phone" data-appear-animation="rotateInUpLeft" data-appear-animation-delay="800"></span>';
                        ?>
